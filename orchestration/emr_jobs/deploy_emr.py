...
if __name__ == "__main__":
    ...
    security_groups = {
        "manager": "sg-072487ebe7bef51bd",
        "worker": "sg-0be0eb36de906d51b",
    }
    bootstrap_actions = [
        {
            "Name": "install-deps",
    ...
    steps = [
        {
            "Name": f"simple-parallel-task-{uuid4()}",
            ...
            "HadoopJarStep": {
                ...
                "Args": [
                    ...
                    "--deploy-mode",
                    "cluster",
                    "s3://flight-emr/scripts/simple-parallel-task.py",
                ],
            },
        },
    ]
    instances = {
        ...
        "Ec2SubnetId": "subnet-094298f497ff72f71",
