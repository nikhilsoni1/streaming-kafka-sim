...
from depr_render_rig.data_access.database.session_manager import (
    get_log_registry_session,
)
from depr_render_rig.data_access.object_access.session_manager import (
    create_boto3_client,
)
...
log_data = get_log_data(
    "1fc1b7b4-a68a-491b-8984-3234ed71be08", db_log_registry_session, s3_client
)
